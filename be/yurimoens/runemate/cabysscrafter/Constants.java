...
public class Constants {
    ...
    public static final int[] WILDERNESS_WALLS = { -694400184, -181306661 };

    public static final Area.Circular bankArea = new Area.Circular(new Coordinate(3097, 3496), 3D);
    public static final Area.Circular mageArea = new Area.Circular(new Coordinate(3106, 3555, 0), 9D);
    ...
    public static final Coordinate wildernessWall = new Coordinate(3103, 3521);
